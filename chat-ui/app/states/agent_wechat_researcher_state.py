...
from app.api.agent_api import STREAM_AGENT_WECHATRESEARCHER_BACKEND_URL, get_agent_api
from app.states.state import Message, Parameters, State

logger = logging.getLogger(__name__)

_INTRODUCTION = "Hi! I'm **Nova Agent WeChat researcher**, a helpful assistant."
MAX_TOTAL_CHARS = 150000  # 总字符保护限制
_DEFAULT_NAME = "Nova"


class AgentWeChatResearcherState(State):
    unique_id = "Agent - WeChat researcher"
