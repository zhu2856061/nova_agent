...
_INTRODUCTION = "Hi! I'm **Nova Agent AiNovelArchitect**, a helpful assistant."
MAX_TOTAL_CHARS = 150000  # 总字符保护限制
_DEFAULT_NAME = "Nova"


class AgentAiNovelArchitectState(State):
    ...
    async def process_question(self, form_data: dict[str, Any]):
        ...
        _url = STREAM_AGENT_AINOVEL_ARCHITECT_BACKEND_URL
        ...
        async for item in get_agent_api(
            _url,
            self.current_chat,
            {"architecture_messages": messages},
            config,
            {"agent_name": "ainovel_architect", "result": question},
        ):  # type: ignore
