...
_INTRODUCTION = "Hi! I'm **Nova Agent AiNovelChapter**, a helpful assistant."
MAX_TOTAL_CHARS = 150000  # 总字符保护限制
_DEFAULT_NAME = "Nova"


class AgentAiNovelChapterState(State):
    ...
    params_fields: list[Parameters] = [
        ...
        Parameters(
            mkey="number_of_creative_chapters",
            mtype="text",
            mvalue=1,
            mvaluetype="int",
            mselected=None,
    ...
    async def process_question(self, form_data: dict[str, Any]):
        ...
        _url = STREAM_AGENT_AINOVEL_CHAPTER_BACKEND_URL
        ...
        async for item in get_agent_api(
            ...
            config,
            {"agent_name": "ainovel_chapter", "result": question},
        ):  # type: ignore
