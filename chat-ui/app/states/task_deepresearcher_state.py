...
_INTRODUCTION = "Hi! I'm **Nova Task Deepresearcher**, a helpful assistant."
MAX_TOTAL_CHARS = 150000  # 总字符保护限制
_DEFAULT_NAME = "Nova"


class TaskDeepresearcherState(State):
    unique_id = "Task - Deepresearcher"
    ...
    params_fields: list[Parameters] = [
        ...
        Parameters(
            mkey="max_concurrent_research_units",
            mtype="text",
            mvalue=2,
            mvaluetype="int",
            mselected=None,
