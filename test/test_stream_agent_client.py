...
async def stream_agent_client():
    ...
    async with httpx.AsyncClient(timeout=600.0) as client:
        ...
        async with client.stream(
            "POST",
            "http://0.0.0.0:2021/agent/stream_theme_slicer",
            json=request_data,
            timeout=3600.0,
        ) as response:
            # 检查响应状态码
...
if __name__ == "__main__":
    ...
    asyncio.run(stream_human_client())
