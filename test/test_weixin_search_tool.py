...
from nova.tools.weixin_crawler import crawl_weixin_tool
from nova.tools.weixin_serper import serp_weixin_tool

# result = serp_weixin_tool.invoke(
#     {
#         "query": "大模型",
#         "max_results": 2,
#     }
...
result = crawl_weixin_tool.invoke(
    {
        "url": "https://weixin.sogou.com/link?url=dn9a_-gY295K0Rci_xozVXfdMkSQTLW6cwJThYulHEtVjXrGTiVgS7ROGf8sroaAy0Z_i_kKHxgfk1JSvZ_ZBVqXa8Fplpd9wZnEr2K06r6oW5ZG-ORSYaJc6vEh7r6oi58KibdTwf6XDGC2sbhg8yuE7m2cgY_IctUwBA-CEZQ-cIkNf2CvPz0JtqwvWO14mnZ4pYjy0TtSBpDxe3qAgPsCu0slMDehBy3wjsmE_QDa4NZ-3fXTXcVOA21F1u2MdMpGrvKXpex5LU3lqtPw9g..&type=2&query=%E5%A4%A7%E6%A8%A1%E5%9E%8B&token=A512E994CCA571BB60665E80EB5F195961B011AF68C8C5AC",
    }
)
...
#     get_wechat_article(query="大模型", number=2)
